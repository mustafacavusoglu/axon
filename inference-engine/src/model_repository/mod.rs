    ...
    for entry in entries.flatten() {
        ...
        for version in versions {
            ...
            if platform == "script" {
                ...
                // If external data files are present (e.g. bert.onnx.data) cap
                // concurrency at 1 unless the config explicitly sets it higher.
                // Loading N sessions × a large .data file causes an apparent hang.
                ...
                let effective_concurrency: u32 = if has_external {
